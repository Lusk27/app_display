...
df= pd.read_csv('https://raw.githubusercontent.com/BYUIDSconsulting/agecon_slade_fa22/master/personal_folders/trey_lusk/Data/FULL_CASH.csv?token=GHSAT0AAAAAAB5X2LK2OP4TZW75MFV3QOUSZBMXHRQ')
