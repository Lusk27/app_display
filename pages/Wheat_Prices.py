...
df= pd.read_csv('https://raw.githubusercontent.com/BYUIDSconsulting/agecon_slade_fa22/master/personal_folders/trey_lusk/Data/FULL_CASH.csv?token=GHSAT0AAAAAAB5X2LK3UL63Y7VP2DTH3OC4ZBMUNPQ')
